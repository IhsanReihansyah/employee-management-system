    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-xs text-slate-500 mt-1">Dafrarkan divisi atau unit kerja baru ke dalam struktur organisasi perusahaan.</p>
            </div>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden">
                <div class="p-6 border-b border-slate-100 bg-slate-50/50">
                    <h3 class="text-lg font-bold text-slate-900">Formulir Divisi Baru</h3>
                    <p class="text-xs text-slate-500 mt-0.5">Sistem akan menggunakan kode ini sebagai kunci relasi kelompok data staf.</p>
                </div>
                ...
                <form action="{{ route('departments.store') }}" method="POST" class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="department_code" value="{{ old('department_code') }}" placeholder="Contoh: HRD, IT-DEPT"
                                class="block w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm placeholder-slate-400 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 shadow-sm transition-all text-slate-900 font-mono uppercase">
                        </div>

                        <!-- Nama Departemen -->
                        <div>
                            <label class="text-sm font-semibold text-slate-700 block mb-1.5">Nama Departemen / Divisi</label>
                            <input type="text" name="department_name" value="{{ old('department_name') }}" placeholder="Contoh: Human Resource Development"
